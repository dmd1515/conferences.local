        ...
        <form method="GET" action="{{ route('shop.index') }}" id="sortForm">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div>
                    ...
                    <select id="sort" name="sort" class="form-control d-inline-block w-auto" onchange="document.getElementById('sortForm').submit();">
                    ...
                    <div class="card product-card shadow-sm">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="price mb-2">
                                <span class="text-primary font-weight-bold">${{ number_format($product->sale_price ?? $product->price, 2) }}</span>
                                @if($product->sale_price)
